...
export class RequestView extends UI.Widget.VBox {
    ...
    constructor(request) {
        ...
        this._tabbedPane.appendTab('headers', Common.UIString.UIString('Headers'), new Network.RequestHeadersView.RequestHeadersView(request));
        this._tabbedPane.appendTab('preview', Common.UIString.UIString('Preview'), new Network.RequestPreviewView.RequestPreviewView(request));

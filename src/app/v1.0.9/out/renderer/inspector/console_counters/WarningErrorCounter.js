...
export class WarningErrorCounter {
    constructor() {
        ...
        function createCounter(parent, delegate) {
            ...
            const shadowRoot = UI.Utils.createShadowRootWithCoreStyles(container, { cssFile: 'console_counters/warningErrorCounter.css', enableLegacyPatching: true, delegatesFocus: undefined });

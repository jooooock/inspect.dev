...
export class ConsolePin extends Common.ObjectWrapper.ObjectWrapper {
    ...
    <div class='console-pin'>
      ...
      <div class='console-pin-preview' $='preview'></div>
        ...
        this._pinPreview.addEventListener('click', /** @param {!Event} event */ /** @param {!Event} event */ event => {
            if (this._lastNode) {
        ...
        */
        ...
        const extension = /** @type {!Root.Runtime.Extension} */ (Root.Runtime.Runtime.instance().extension(UI.TextEditor.TextEditorFactory));
        this._editorPromise =

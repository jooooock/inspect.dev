...
export const _attributeMarker = /** @param {number} index */ /** @param {number} index */ index => 'template-attribute' + index;
const _attributeMarkerRegex = /template-attribute\d+/;
const _class = /** @param {number} index */ /** @param {number} index */ index => 'template-class-' + index;

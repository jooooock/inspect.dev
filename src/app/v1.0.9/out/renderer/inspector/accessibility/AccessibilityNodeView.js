    ...
    setAXNode(axNode) {
        ...
        if (axNode.ignored()) {
            ...
            function addIgnoredReason(property) {
                ignoredReasons.appendChild(new AXNodeIgnoredReasonTreeElement(property, /** @type {!SDK.AccessibilityModel.AccessibilityNode} */ (axNode)));
            }
        ...
        function addProperty(property) {
            treeOutline.appendChild(new AXNodePropertyTreePropertyElement(property, /** @type {!SDK.AccessibilityModel.AccessibilityNode} */ (axNode)));
        }
...
export class AXValueSourceTreeElement extends AXNodePropertyTreeElement {
    ...
    _update() {
        ...
        if (this._source.attributeValue) {
            ...
            const valueElement = AXNodePropertyTreeElement.createSimpleValueElement(Protocol.Accessibility.AXValueType.ValueUndefined, ls `Not specified`);
...
export class AXRelatedNodeSourceTreeElement extends UI.TreeOutline.TreeElement {
    ...
    onattach() {
        ...
        if (this._value.text) {
            this.listItemElement.appendChild(AXNodePropertyTreeElement.createSimpleValueElement(Protocol.Accessibility.AXValueType.ComputedString, this._value.text));
        }
    }
    /**
     * @override

...
export class AudioContextSelector extends Common.ObjectWrapper.ObjectWrapper {
    ...
    createElementForItem(item) {
        ...
        const shadowRoot = UI.Utils.createShadowRootWithCoreStyles(element, { cssFile: 'web_audio/audioContextSelector.css', enableLegacyPatching: false, delegatesFocus: undefined });

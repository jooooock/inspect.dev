...
export class TextEditorAutocompleteController {
    ...
    _addWordsFromText(text) {
        TextUtils.TextUtils.Utils.textToWords(text, /** @type {function(string):boolean} */ (this._config.isWordChar), addWord.bind(this));
        /**
         * @param {string} word
    ...
    _removeWordsFromText(text) {
        TextUtils.TextUtils.Utils.textToWords(text, /** @type {function(string):boolean} */ (this._config.isWordChar), word => this._dictionary && this._dictionary.removeWord(word));
    }
    /**
    ...
    _setHint(hint) {
        ...
        if (!this._hintMarker) {
            this._hintMarker = this._textEditor.addBookmark(cursor.line, cursor.ch, /** @type {!HTMLElement} */ (this._hintElement), TextEditorAutocompleteController.HintBookmark, true);
        }

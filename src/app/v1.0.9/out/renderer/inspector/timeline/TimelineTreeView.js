...
export class TimelineTreeView extends UI.Widget.VBox {
    ...
    populateToolbar(toolbar) {
        const textFilterUI = new UI.Toolbar.ToolbarInput(Common.UIString.UIString('Filter'), this.getToolbarInputAccessiblePlaceHolder());
    ...
    populateColumns(columns) {
        ...
        columns.push(/** @type {!DataGrid.DataGrid.ColumnDescriptor} */ ({ id: 'activity', title: Common.UIString.UIString('Activity'), disclosure: true, sortable: true }));
    }
    _sortingChanged() {

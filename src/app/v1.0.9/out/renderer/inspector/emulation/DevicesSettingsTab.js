...
export class DevicesSettingsTab extends UI.Widget.VBox {
    ...
    _createEditor() {
        ...
        const brands = editor.createInput('brands', 'text', ls `UA brands list (e.g. "Chromium";v="87")`, brandListValidator);
        addToTree(brands);
        const fullVersion = editor.createInput('full-version', 'text', ls `Full browser version (e.g. 87.0.4280.88)`, chStringValidator);

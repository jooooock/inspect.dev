...
class LinearMemoryInspectorView extends UI.Widget.VBox {
    ...
    constructor(memoryWrapper, address) {
        ...
        this._inspector.addEventListener('memory-request', /** @param {!Event} event */ /** @param {!Event} event */ event => {
            this._memoryRequested(/** @type {?} */ (event));
        });
        this._inspector.addEventListener('address-changed', /** @param {?} event */ /** @param {?} event */ event => {

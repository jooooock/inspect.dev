...
export const UIStrings = {
    ...
    *@description Text in Lighthouse Controller
    */
    resetStorageLocalstorage: 'Reset storage (localStorage, IndexedDB, etc) before auditing. (Good for performance & PWA testing)'
};
...
export class LighthouseController extends Common.ObjectWrapper.ObjectWrapper {
    ...
    constructor(protocolService) {
        ...
        SDK.SDKModel.TargetManager.instance().addEventListener(SDK.SDKModel.Events.InspectedURLChanged, this.recomputePageAuditability, this);
    }
    /**
     * @override

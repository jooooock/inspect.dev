...
import { Events, RuntimeSettings } from './LighthouseController.js'; // eslint-disable-line no-unused-vars
...
export class StatusView {
    ...
    _render() {
        const dialogRoot = UI.Utils.createShadowRootWithCoreStyles(this._dialog.contentElement, { cssFile: 'lighthouse/lighthouseDialog.css', enableLegacyPatching: false, delegatesFocus: undefined });

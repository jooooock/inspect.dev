...
export class QuickOpenImpl {
    ...
    static show(query) {
        ...
        filteredListWidget.setPlaceholder(ls `Type '?' to see available commands`, ls `Type question mark to see available commands`);
    ...
    _addProvider(extension) {
        ...
        this._providers.set(prefix, /** @type {function():!Promise<!Provider>} */ (extension.instance.bind(extension)));
    }
    /**
     * @param {string} query
     */

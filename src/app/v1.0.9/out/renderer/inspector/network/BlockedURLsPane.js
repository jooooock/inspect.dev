...
export class BlockedURLsPane extends UI.Widget.VBox {
    constructor() {
        ...
        this._enabledCheckbox = new UI.Toolbar.ToolbarCheckbox(Common.UIString.UIString('Enable network request blocking'), undefined, this._toggleEnabled.bind(this));
        ...
        const clearButton = new UI.Toolbar.ToolbarButton(Common.UIString.UIString('Remove all patterns'), 'largeicon-clear');

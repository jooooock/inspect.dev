...
export class NetworkConfigView extends UI.Widget.VBox {
    ...
    _createCacheSection() {
        ...
        section.appendChild(UI.SettingsUI.createSettingCheckbox(Common.UIString.UIString('Disable cache'), Common.Settings.Settings.instance().moduleSetting('cacheDisabled'), true));
    }

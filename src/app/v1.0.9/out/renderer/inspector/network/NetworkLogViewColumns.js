...
export class NetworkLogViewColumns {
    ...
    _setupWaterfall() {
        ...
        this._waterfallScroller = /** @type {!HTMLDivElement} */ (this._waterfallColumn.contentElement.createChild('div', 'network-waterfall-v-scroll'));
        this._waterfallScrollerContent = /** @type {!HTMLDivElement} */ (this._waterfallScroller.createChild('div', 'network-waterfall-v-scroll-content'));
    ...
    _createWaterfallHeader() {
        this._waterfallHeaderElement = /** @type {!HTMLElement} */ (this._waterfallColumn.contentElement.createChild('div', 'network-waterfall-header'));
    ...
    _innerHeaderContextMenu(contextMenu) {
        ...
        for (const group of hideableGroups.values()) {
            ...
            for (const columnConfig of group) {
                ...
                contextMenu.headerSection().appendCheckboxItem(columnConfig.title, this._toggleColumnVisibility.bind(this, columnConfig), columnConfig.visible, isDisabled);
            }
        ...
        for (const columnConfig of nonResponseHeadersWithoutGroup) {
            contextMenu.headerSection().appendCheckboxItem(columnConfig.title, this._toggleColumnVisibility.bind(this, columnConfig), columnConfig.visible);
        }
        ...
        for (const columnConfig of responseHeaders) {
            responseSubMenu.defaultSection().appendCheckboxItem(columnConfig.title, this._toggleColumnVisibility.bind(this, columnConfig), columnConfig.visible);
        }
        responseSubMenu.footerSection().appendItem(Common.UIString.UIString('Manage Header Columns…'), this._manageCustomHeaderDialog.bind(this));
        ...
        waterfallSubMenu.defaultSection().appendCheckboxItem(Common.UIString.UIString('Start Time'), setWaterfallMode.bind(this, waterfallSortIds.StartTime), this._activeWaterfallSortId === waterfallSortIds.StartTime);
        waterfallSubMenu.defaultSection().appendCheckboxItem(Common.UIString.UIString('Response Time'), setWaterfallMode.bind(this, waterfallSortIds.ResponseTime), this._activeWaterfallSortId === waterfallSortIds.ResponseTime);
        waterfallSubMenu.defaultSection().appendCheckboxItem(Common.UIString.UIString('End Time'), setWaterfallMode.bind(this, waterfallSortIds.EndTime), this._activeWaterfallSortId === waterfallSortIds.EndTime);
        waterfallSubMenu.defaultSection().appendCheckboxItem(Common.UIString.UIString('Total Duration'), setWaterfallMode.bind(this, waterfallSortIds.Duration), this._activeWaterfallSortId === waterfallSortIds.Duration);
        waterfallSubMenu.defaultSection().appendCheckboxItem(Common.UIString.UIString('Latency'), setWaterfallMode.bind(this, waterfallSortIds.Latency), this._activeWaterfallSortId === waterfallSortIds.Latency);
        /**

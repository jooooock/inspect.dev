...
import { HeapTimelineOverview, IdsRangeChanged } from './HeapTimelineOverview.js'; // eslint-disable-line no-unused-vars
...
function convertToSamplingHeapProfile(profileHeader) {
    return /** @type {!Protocol.HeapProfiler.SamplingHeapProfile} */ (profileHeader._profile || profileHeader.protocolProfile());
}
/**
...
export class SamplingHeapProfileHeader extends WritableProfileHeader {
    ...
    constructor(heapProfilerModel, type, title) {
        super(heapProfilerModel && heapProfilerModel.debuggerModel(), type, title || Common.UIString.UIString('Profile %d', type.nextProfileUid()));

...
export class LiveHeapProfileView extends UI.Widget.VBox {
    ...
    constructor() {
        ...
        this._toggleRecordAction =
            /** @type {!UI.ActionRegistration.Action }*/ (UI.ActionRegistry.ActionRegistry.instance().action('live-heap-profile.toggle-recording'));
        ...
        if (mainTarget && mainTarget.model(SDK.ResourceTreeModel.ResourceTreeModel)) {
            ...
            /** @type {!UI.ActionRegistration.Action }*/ (UI.ActionRegistry.ActionRegistry.instance().action('live-heap-profile.start-with-reload'));
    ...
    _startRecording(reload) {
        ...
        const resourceTreeModel = /** @type {?SDK.ResourceTreeModel.ResourceTreeModel} */ (mainTarget.model(SDK.ResourceTreeModel.ResourceTreeModel));

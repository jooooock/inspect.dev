...
export class IsolateSelector extends UI.Widget.VBox {
    constructor() {
        ...
        UI.Tooltip.Tooltip.install(this._totalTrendDiv, ls `Total page JS heap size change trend over the last ${trendIntervalMinutes} minutes.`);
...
export class ListItem {
    ...
    constructor(isolate) {
        ...
        UI.Tooltip.Tooltip.install(this._trendDiv, ls `Heap size change trend over the last ${trendIntervalMinutes} minutes.`);

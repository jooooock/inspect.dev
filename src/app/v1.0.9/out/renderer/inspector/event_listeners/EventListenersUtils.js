    ...
    function convertToEventListeners(pageEventListenersObject) {
        ...
        function toEventListener(listenerObject) {
            ...
            function createEventListener() {
                ...
                /** @type {!SDK.DOMDebuggerModel.DOMDebuggerModel} */ (domDebuggerModel), object, type, useCapture, passive, once, handler, originalHandler, location, removeFunctionObject, SDK.DOMDebuggerModel.EventListener.Origin.FrameworkUser);
            }
        }
    }
    /**
        ...
        function checkEventListener(eventListener) {
            try {
                ...
                if (!eventListener) {
                    ...
                    if (!errorString) {
                        return /** @type {!EventListenerObjectInInspectedPage} */ ({ type: type, useCapture: useCapture, passive: passive, once: once, handler: handler, remove: remove });
                    }
                }

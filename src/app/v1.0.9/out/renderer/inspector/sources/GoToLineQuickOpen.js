    ...
    notFoundText(query) {
        ...
        if (!position) {
            ...
            if (disassembly) {
                ...
                return ls `Current position: 0x${currentPosition.toString(16).padStart(bytecodeOffsetDigits, '0')}. Type an offset between 0x${'0'.padStart(bytecodeOffsetDigits, '0')} and 0x${lastBytecodeOffset.toString(16)} to navigate to.`;
            }

...
export class FormattedContentBuilder {
    constructor(indentString) {
        ...
        this.lastOriginalPosition = 0;
        this.formattedContent = [];
        this.formattedContentLength = 0;
        this.lastFormattedPosition = 0;
        this.nestingLevel = 0;
        this.newLines = 0;
        this.enforceSpaceBetweenWords = true;
        this.softSpace = false;
        this.hardSpaces = 0;
        this.cachedIndents = new Map();
        this.mapping = { original: [0], formatted: [0] };
    }

...
exports.DOM = void 0;
const getBoxQuards_1 = __importDefault(require("./utils/getBoxQuards"));
class DOM {
    ...
    async pushNodesByBackendIdsToFrontend(msg) {
    ...
    async getBoxModel(msg) {
        ...
        try {
            ...
            let quards = (0, getBoxQuards_1.default)(boundingClientRect, computedStyles);
            let result = {
                model: {
